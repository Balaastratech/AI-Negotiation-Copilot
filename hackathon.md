...
Include a URL to your public code repository to show how your project was built. The code repository must be public to allow access for judging and testing.Spin-up Instructions: A step-by-step guide in your README.md explaining how to set up and run the project locally or deploy it to the cloud. Even if the judges do not run it, these instructions prove the project is reproducible.
...
Include a demonstration video of your Project. The video portion of the Project:Should include footage that shows the Project in action. We want to see the Multimodal/Agentic features working in real-time (e.g. no mockups; show the actual software)
